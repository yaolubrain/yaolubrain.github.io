...
function init() {
    ...
    camera = new THREE.PerspectiveCamera( 75, window.innerWidth / window.innerHeight, 0.010, 10000 );
...
function onKeyDown( event ) {      
    if (event.keyCode == "80") {
        ...
        saveFile(imgData.replace(strMime, strDownloadMime), "curet_dosnes.png");
