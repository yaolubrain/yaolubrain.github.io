...
function init() {
    ...
    var classColor = [];
    for ( var i = 0; i < 49; ++i ) {  
        var color = new THREE.Color( (i / 49 + 0.01) * 0xffff00 );      
        classColor[i] = color;
    }
...
function onKeyDown( event ) {      
    if (event.keyCode == "80") {
        ...
        saveFile(imgData.replace(strMime, strDownloadMime), "timit.jpg");
